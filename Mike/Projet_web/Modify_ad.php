    ...
    <div class="container">
     <h1></h1>
             ...
             <div class="form-group">
                   ...
                   <input type="text" class="form-control" value="<?php echo $_GET['modifanon']?>" name="n_id" id="id" readonly >
                </div>
                <div class="form-group">
              ...
              <br/><br/>
                <button class="btn btn-primary" type="submit" name="btmodsubmit" value="">submit</button> 
                <input class="btn btn-primary" type="reset"  name="btmodreset" value="reset">
              </form>
        </div>
        ...
        <?php
            ...
            $requete="UPDATE `Ad` SET `address`='$adress_exp',`price`='$prix',`image`='$target',`location`='$lieux',`type`='$type',`status`='Active' , `surface`='$surf' , `room_number`='$num_chambre' WHERE id='$modifier' && id_users='0'";
